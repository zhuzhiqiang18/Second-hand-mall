	...
	<body>
		<div class="Manage-line line">
			<div class="tab table-bordered">
				<div class="tab-head">
					<strong><i class="fa fa-list-ul"></i>栏目管理>栏目分类>推荐</strong> <span class="tab-more"><a href="javascript:history.go(-1)">返回上一页</a></span>
					<ul class="tab-nav">
				...
				<div class="tab-body">
					<div class="tab-panel active" id="tab-start">
						<div class="line">
							<div class="x6">
							<a href="tj_addar.action"><button class="Member-modify dialogs" onclick="Addcolumn()">添加推荐词</button></a>
							</div>
						</div>
							...
							<table class="table table-hover">
								...
								<tbody>
									<tr>
										...
										<td>
											<a href="tj_delete.action?id=${id}"><button class="modify-button" onclick="modify()">删除</button></a>
										</td>
									</tr>
								</tbody>
								</s:iterator>
