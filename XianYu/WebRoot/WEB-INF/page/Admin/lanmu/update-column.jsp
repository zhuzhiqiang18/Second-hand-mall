		...
		<div class="Manage-line line">
			<div class="tab table-bordered">
				<div class="tab-head">
					...
					<ul class="tab-nav">
						<li class="active"><a href="#tab-start">更新栏目</a></li>
					</ul>
				</div>
				<div class="tab-body">
					<div class="tab-panel active" id="tab-start">
						<form action="lanmu_update.action?id=${id}" method="post">
							<div class="line">
								<div class="x2">
									<strong>栏目名：</strong>
								</div>
								<div class="x3">
									<s:textfield type="text" cssClass="input" name="name"/>
								</div>
								<div class="x7">
							...
							<div class="line">
								...
								<div class="x3">
									<s:textfield type="text" cssClass="input" name="adminName"/>
								</div>
								<div class="x7">
