	...
	<body>
		<div class="Manage-line line">
			<div class="tab table-bordered">
				<div class="tab-head">
					<strong><i class="fa fa-list-ul"></i>栏目管理>栏目分类>${name}</strong> <span class="tab-more"><a href="javascript:history.go(-1)">返回上一页</a></span>
					<ul class="tab-nav">
				...
				<div class="tab-body">
					<div class="tab-panel active" id="tab-start">
						<div class="line">
							...
							<div class="x6">
								<a href="lanmu_addyjlmpage.action?id=${id}"><button class="Member-modify dialogs" onclick="Addcolumn()">添加栏目</button></a>
							</div>
						</div>
