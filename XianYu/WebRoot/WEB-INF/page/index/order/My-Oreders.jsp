...
<link rel="stylesheet" type="text/css"
	href="js/font-awesome-4.5.0/css/font-awesome.min.css" />
		...
		<div class="My-Oreders line">
			...
			<div class="x10">
				...
				<div class="x10-line line">
					...
					<div class="x4"></div>
					<div class="x4">
						<form action="order_ssbuy.action" method="post">
							<ul>
								<li>&nbsp;</li>
								...
								<div class="Order-details-line line">
									...
									<div class="x3">
										<p>
											...
											<a href="order_buy_ok.action?id=${id}"><s:if test="%{zhuangtai==0}">未付款(点击付款)</s:if></a>
									...
									<s:if test="%{zhuangtai==2}">
										<div class="x3">
											<a href="order_shouhuoar.action?id=${id}"><button class="button bg-green button-little">确认收货</button></a>
										</div>
